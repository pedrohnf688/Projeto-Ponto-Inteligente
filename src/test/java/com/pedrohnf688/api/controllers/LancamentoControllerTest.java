...
public class LancamentoControllerTest {
	...
	@Autowired
	private LancamentoService lancamentoSerivce;
	...
	public void testCadastrarLancamento() throws Exception {
        ...
        BDDMockito.given(this.lancamentoSerivce.Persistir(Mockito.any(Lancamento.class))).willReturn(lancamento);
        ...
        mvc.perform(MockMvcRequestBuilders.post(URL_BASE)
                ...
                .andExpect(jsonPath("$.data.data").value(this.dateFormate.format(DATA)))
	...
	public void testCadastrarLancamentoFuncionarioIdInvalido() throws Exception {
		...
		mvc.perform(MockMvcRequestBuilders.post(URL_BASE)
                ...
                .andExpect(jsonPath("$.errors").value("Funcionario não encontrado. Id inexsistente"))
	...
	public void testRemoverLancamento() throws Exception {
		BDDMockito.given(this.lancamentoSerivce.buscarPorId(Mockito.anyLong())).willReturn(Optional.of(new Lancamento()));
	...
	private String obterJsonRequisicaoPost() throws JsonProcessingException {
		...
		lancamentoDto.setData(this.dateFormate.format(DATA));
